...
interface RegisterPageProps {
  // Cập nhật: Thêm tham số username vào hàm onRegister
  onRegister: (
    username: string, 
    email: string,
    password: string,
        ...
        <div className="bg-white rounded-lg border p-6 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`w-full text-white py-2 px-4 rounded-md transition duration-200 mt-4
